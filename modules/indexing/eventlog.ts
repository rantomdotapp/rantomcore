...
import { ContextServices, IAdapter, IEventlogIndexing } from '../../types/namespaces';
import { BlockchainIndexingRunOptions } from '../../types/options';
import { getAdapters } from '../adapters';

export default class EventlogIndexing implements IEventlogIndexing {
  public readonly name: string = 'indexing.eventlog';
